...
# Menedżery pakietów
npm i -g skyforge-ai@latest        # albo bun/pnpm/yarn
...
Jeśli pracujesz nad projektem związanym z OpenCode i używasz "skyforge" jako części nazwy (na przykład "skyforge-dashboard" lub "skyforge-mobile"), dodaj proszę notatkę do swojego README, aby wyjaśnić, że projekt nie jest tworzony przez zespół OpenCode i nie jest z nami w żaden sposób powiązany.
