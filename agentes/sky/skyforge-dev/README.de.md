...
# Paketmanager
npm i -g skyforge-ai@latest        # oder bun/pnpm/yarn
...
paru -S skyforge-bin               # Arch Linux (Latest from AUR)
...
Wenn du an einem Projekt arbeitest, das mit OpenCode zusammenhängt und "skyforge" als Teil seines Namens verwendet (z.B. "skyforge-dashboard" oder "skyforge-mobile"), füge bitte einen Hinweis in deine README ein, dass es nicht vom OpenCode-Team gebaut wird und nicht in irgendeiner Weise mit uns verbunden ist.
