...
# مديري الحزم
npm i -g skyforge-ai@latest        # او bun/pnpm/yarn
...
اذا كنت تعمل على مشروع مرتبط بـ OpenCode ويستخدم "skyforge" كجزء من اسمه (مثل "skyforge-dashboard" او "skyforge-mobile")، يرجى اضافة ملاحظة في README توضح انه ليس مبنيا بواسطة فريق OpenCode ولا يرتبط بنا بأي شكل.
