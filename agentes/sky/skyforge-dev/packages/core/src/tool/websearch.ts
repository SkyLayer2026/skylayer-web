...
import { ToolFailure, toolText } from "@skyforge/llm"
...
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.SKYFORGE_WEBSEARCH_PROVIDER === "exa" || process.env.SKYFORGE_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.SKYFORGE_WEBSEARCH_PROVIDER
        : undefined,
