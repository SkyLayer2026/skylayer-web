...
import { LocationServiceMap } from "@skyforge/core/location-layer"
...
function ref(request: HttpServerRequest.HttpServerRequest): Location.Ref {
  ...
  const workspaceID = query.get("location[workspace]") || request.headers["x-skyforge-workspace"]
  return {
    directory: AbsolutePath.make(
      query.get("location[directory]") || request.headers["x-skyforge-directory"] || process.cwd(),
    ),
