...
export const TypeId: TypeId = "~@skyforge/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@skyforge/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@skyforge/effect-sqlite-node/NodeSqliteClient")
