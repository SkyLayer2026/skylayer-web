import type { TuiPluginApi } from "@skyforge/plugin/tui"
...
const TIPS: Tip[] = [
  ...
  "Create {highlight}skyforge.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  ...
  "Add {highlight}.md{/highlight} files to {highlight}.skyforge/commands/{/highlight} to define reusable custom prompts",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "Use backticks in commands to inject shell output (e.g., {highlight}`git status`{/highlight})",
  "Add {highlight}.md{/highlight} files to {highlight}.skyforge/agents/{/highlight} for specialized AI personas",
  ...
  "Create {highlight}.ts{/highlight} files in {highlight}.skyforge/tools/{/highlight} to define new LLM tools",
  "Tool definitions can invoke scripts written in Python, Go, etc",
  "Add {highlight}.ts{/highlight} files to {highlight}.skyforge/plugins/{/highlight} for event hooks",
  ...
  "Create JSON theme files in {highlight}.skyforge/themes/{/highlight} directory",
