...
export const RootHttpApi = HttpApi.make("skyforge-root")
...
export const InstanceHttpApi = HttpApi.make("skyforge-instance")
...
export const OpenCodeHttpApi = HttpApi.make("skyforge")
