...
import { AttentionSoundName, type TuiConfig } from "@skyforge/tui/config"
import { Schema } from "effect"
import stripAnsi from "strip-ansi"
import * as TuiAudio from "./audio"
import defaultSoundPath from "@skyforge/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@skyforge/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@skyforge/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@skyforge/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@skyforge/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@skyforge/ui/audio/yup-01.mp3" with { type: "file" }
