import type { PermissionV1 } from "@skyforge/core/v1/permission"
...
import { createOpencodeClient, type OpencodeClient, type ToolPart } from "@skyforge/sdk/v2"
...
export const RunCommand = effectCmd({
  command: "run [message..]",
  describe: "run skyforge with a message",
  ...
  builder: (yargs: Argv) =>
    yargs
      ...
      .option("attach", {
        type: "string",
        describe: "attach to a running skyforge server (e.g., http://localhost:4096)",
      })
      .option("password", {
        alias: ["p"],
        type: "string",
