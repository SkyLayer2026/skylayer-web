import type * as SDK from "@skyforge/sdk/v2"
...
import { SessionShareTable } from "@skyforge/core/share/sql"
...
const disabled = process.env["SKYFORGE_DISABLE_SHARE"] === "true" || process.env["SKYFORGE_DISABLE_SHARE"] === "1"
