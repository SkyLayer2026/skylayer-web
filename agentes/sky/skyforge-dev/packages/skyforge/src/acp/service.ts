...
import type { Message, OpencodeClient, SessionMessageResponse } from "@skyforge/sdk/v2"
...
export const AuthMethodID = "skyforge-login"
...
function defaultModelFromConfig(
  ...
  const opencodeProvider = providers[ProviderV2.ID.make("skyforge")]
