import type { JsonSchema, LLMRequest, ProviderMetadata } from "@skyforge/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@skyforge/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @skyforge/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
