import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@skyforge/llm"
...
// Move this extraction into @skyforge/llm when Copilot is handled by the native runtime.
