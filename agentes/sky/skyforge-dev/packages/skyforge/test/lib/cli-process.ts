...
//   - OPENCODE_DISABLE_PROJECT_CONFIG : skip walking up for skyforge.json
//   - SKYFORGE_PURE                : skip external plugin discovery + install
...
function expectExit(result: RunResult, expected: number, label = "skyforge") {
