...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips skyforge-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-skyforge-directory"]).toBeUndefined()
      expect(forwarded["x-skyforge-workspace"]).toBeUndefined()
