  ...
  references.instance(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const cache = path.join(Global.Path.repos, "github.com", "skyforge-glob-reference", "repo")
        ...
        const remoteDir = path.join(remoteRoot, "skyforge-glob-reference")
      ...
      }),
    {
      config: {
        reference: {
          docs: "skyforge-glob-reference/repo",
        },
      },
    },
  )
