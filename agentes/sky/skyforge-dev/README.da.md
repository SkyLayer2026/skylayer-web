...
# Pakkehåndteringer
npm i -g skyforge-ai@latest        # eller bun/pnpm/yarn
...
Hvis du arbejder på et projekt der er relateret til OpenCode og bruger "skyforge" som en del af navnet; f.eks. "skyforge-dashboard" eller "skyforge-mobile", så tilføj en note i din README, der tydeliggør at projektet ikke er bygget af OpenCode-teamet og ikke er tilknyttet os på nogen måde.
