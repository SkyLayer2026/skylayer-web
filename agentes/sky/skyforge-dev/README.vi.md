...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/skyforge-ai"><img alt="npm" src="https://img.shields.io/npm/v/skyforge-ai?style=flat-square" /></a>
...
npm i -g skyforge-ai@latest        # hoặc bun/pnpm/yarn
...
paru -S skyforge-bin               # Arch Linux (Bản mới nhất từ AUR)
...
| Nền tảng              | Tải xuống                          |
| --------------------- | ---------------------------------- |
| macOS (Apple Silicon) | `skyforge-desktop-mac-arm64.dmg`   |
| macOS (Intel)         | `skyforge-desktop-mac-x64.dmg`     |
| Windows               | `skyforge-desktop-windows-x64.exe` |
| Linux                 | `.deb`, `.rpm`, hoặc AppImage      |

```bash
# macOS (Homebrew)
brew install --cask skyforge-desktop
# Windows (Scoop)
scoop bucket add extras; scoop install extras/skyforge-desktop
```
...
Nếu bạn đang làm việc trên một dự án liên quan đến OpenCode và sử dụng "skyforge" như một phần của tên dự án, ví dụ "skyforge-dashboard" hoặc "skyforge-mobile", vui lòng thêm một ghi chú vào README của bạn để làm rõ rằng dự án đó không được xây dựng bởi đội ngũ OpenCode và không liên kết với chúng tôi dưới bất kỳ hình thức nào.
