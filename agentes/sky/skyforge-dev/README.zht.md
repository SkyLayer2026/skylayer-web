...
# 套件管理員
npm i -g skyforge-ai@latest        # 也可使用 bun/pnpm/yarn
...
如果您正在開發與 OpenCode 相關的專案，並在名稱中使用了 "skyforge"（例如 "skyforge-dashboard" 或 "skyforge-mobile"），請在您的 README 中加入聲明，說明該專案並非由 OpenCode 團隊開發，且與我們沒有任何隸屬關係。
