...
- remove the public in-memory `@skyforge/llm` tool loop after replacing its
...
- plugins get global "skyforge" instance like in that post i showed
...
- decide whether to preserve deprecated `@skyforge/llm` orchestration exports
