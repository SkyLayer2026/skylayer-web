...
# パッケージマネージャー
npm i -g skyforge-ai@latest        # bun/pnpm/yarn でもOK
...
OpenCode に関連するプロジェクトで、名前に "skyforge"（例: "skyforge-dashboard" や "skyforge-mobile"）を含める場合は、そのプロジェクトが OpenCode チームによって作られたものではなく、いかなる形でも関係がないことを README に明記してください。
