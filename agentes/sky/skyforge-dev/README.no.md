...
Hvis du jobber med et prosjekt som er relatert til OpenCode og bruker "skyforge" som en del av navnet; for eksempel "skyforge-dashboard" eller "skyforge-mobile", legg inn en merknad i README som presiserer at det ikke er bygget av OpenCode-teamet og ikke er tilknyttet oss på noen måte.
