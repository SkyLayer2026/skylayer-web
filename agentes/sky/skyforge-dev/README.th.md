...
# ตัวจัดการแพ็กเกจ
npm i -g skyforge-ai@latest        # หรือ bun/pnpm/yarn
...
หากคุณทำงานในโปรเจกต์ที่เกี่ยวข้องกับ OpenCode และใช้ "skyforge" เป็นส่วนหนึ่งของชื่อ เช่น "skyforge-dashboard" หรือ "skyforge-mobile" โปรดเพิ่มหมายเหตุใน README ของคุณเพื่อชี้แจงว่าไม่ได้สร้างโดยทีม OpenCode และไม่ได้เกี่ยวข้องกับเราในทางใด
