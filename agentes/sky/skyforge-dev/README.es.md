...
npm i -g skyforge-ai@latest        # o bun/pnpm/yarn
...
Si estás trabajando en un proyecto basado en OpenCode y usas "skyforge" como parte del nombre, por ejemplo, "skyforge-dashboard" u "skyforge-mobile", agrega una nota en tu README para aclarar que no está hecho por el equipo de OpenCode y que no está afiliado con nosotros de ninguna manera.
