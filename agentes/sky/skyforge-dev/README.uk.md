...
# Менеджери пакетів
npm i -g skyforge-ai@latest        # або bun/pnpm/yarn
...
Якщо ви працюєте над проєктом, пов'язаним з OpenCode, і використовуєте "skyforge" у назві, наприклад "skyforge-dashboard" або "skyforge-mobile", додайте примітку до свого README.
