...
# Paket yöneticileri
npm i -g skyforge-ai@latest        # veya bun/pnpm/yarn
...
OpenCode ile ilgili bir proje üzerinde çalışıyorsanız ve projenizin adının bir parçası olarak "skyforge" kullanıyorsanız (örneğin, "skyforge-dashboard" veya "skyforge-mobile"), lütfen README dosyanıza projenin OpenCode ekibi tarafından geliştirilmediğini ve bizimle hiçbir şekilde bağlantılı olmadığını belirten bir not ekleyin.
