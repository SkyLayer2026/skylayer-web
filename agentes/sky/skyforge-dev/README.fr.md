...
Si vous travaillez sur un projet lié à OpenCode et que vous utilisez "skyforge" dans le nom du projet (par exemple, "skyforge-dashboard" ou "skyforge-mobile"), ajoutez une note dans votre README pour préciser qu'il n'est pas construit par l'équipe OpenCode et qu'il n'est pas affilié à nous.
