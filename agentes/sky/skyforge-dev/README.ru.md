...
# Менеджеры пакетов
npm i -g skyforge-ai@latest        # или bun/pnpm/yarn
...
Если вы делаете проект, связанный с OpenCode, и используете "skyforge" как часть имени (например, "skyforge-dashboard" или "skyforge-mobile"), добавьте примечание в README, чтобы уточнить, что проект не создан командой OpenCode и не аффилирован с нами.
